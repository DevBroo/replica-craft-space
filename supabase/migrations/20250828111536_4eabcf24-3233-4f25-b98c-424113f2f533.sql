-- Drop existing functions and recreate with fixed parameter names
...
-- Recreate get_time_series_analytics function with fixed parameter names
...
-- Recreate get_revenue_by_property function with fixed parameter names
...
-- Recreate get_revenue_by_owner function with fixed parameter names
...
-- Recreate get_revenue_by_agent function with fixed parameter names
...
-- Recreate get_top_properties function with fixed parameter names
...
-- Recreate get_highest_rated_properties function with fixed parameter names
