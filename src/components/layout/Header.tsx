            ...
            <div className="hidden lg:flex items-center space-x-4 min-w-[200px] justify-end">
              {isAuthenticated && user ? (
                <div className="flex items-center space-x-4">
                  <div 
                    onClick={() => {
                      console.log('🚀 User avatar clicked, navigating to customer dashboard');
                    ...
                    title={`${user.email} - Click to go to dashboard`}
                  >
                ...
                {isAuthenticated && user ? (
                  <>
                    <div className="flex items-center justify-center bg-gray-50 rounded-lg px-4 py-3">
                      <div 
                        onClick={() => {
                          console.log('🚀 Mobile user avatar clicked, navigating to customer dashboard');
                          navigate('/customer/dashboard');
                          setIsMobileMenuOpen(false);
                        }}
