...
const HostDashboard: React.FC = () => {
  ...
  // Fetch real data using custom hooks with optimized limits for dashboard
  const { properties, loading: propertiesLoading, error: propertiesError } = useOwnerProperties(user?.id || '', 5); // Limit to 5 for dashboard
            ...
            <div className="space-y-4">
              {propertiesLoading ? (
                ...
                <div className="text-center py-4">
                  <div className="text-red-600 mb-2">Failed to load properties</div>
                  <button 
