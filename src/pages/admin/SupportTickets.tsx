...
import { Search, Filter, Plus, Eye, UserCheck, Clock, CheckCircle, AlertTriangle, Download, BarChart3, MessageCircle } from 'lucide-react';
...
const SupportTickets = () => {
  ...
  const handleJoinChat = async (ticketId: string) => {
    try {
      // Navigate to live chat dashboard with the specific ticket ID
      navigate(`/admin/live-chat?ticketId=${ticketId}`);
      toast.success('Redirected to Live Chat Dashboard');
    } catch (error) {
  ...
  const isLiveChatTicket = (ticket: any) => {
    return ticket.category === 'live_chat' ||
          ...
          <div className="border-b border-gray-200 mb-6">
            <nav className="-mb-px flex space-x-8">
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === 'tickets'
              ...
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 ${activeTab === 'reports'
                  ? 'border-blue-500 text-blue-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
                          ...
                          {ticket.assigned_agent_profile?.full_name || 'Unassigned'}
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                              <div className="flex items-center space-x-2">
                                ...
                                {isLiveChatTicket(ticket) && ticket.status === 'open' && (
                                  <button
