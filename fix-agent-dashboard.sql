-- Fix Agent Dashboard Database Issues
...
-- 6. Create the get_agent_commission_summary function (FIXED VERSION)
...
-- 8. Insert default commission settings for existing agents
